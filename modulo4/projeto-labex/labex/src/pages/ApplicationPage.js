        ...
        <ApplicationContainer>
            ...
            <FormContainer>
                ...
                <form onSubmit={onSubmitApplication}>
                    <InputBox required type="text" placeholder="Name"/>
                    <InputBox required type="number" placeholder="Age"/>
                    <InputBox required pattern="[a-z0-9A-Z]{50,}" title="Your message must have at least 50
                    characters." maxLength="140" type="text" placeholder="Message from 50 to 140 characters"/>
                    <InputBox required type="text" placeholder="Profession/Ocupation"/>
                    <SelectCountry required id="country" name="country" class="form-control">
